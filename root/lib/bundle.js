...
/***/ function(module, exports, __webpack_require__) {
	...
	var _recipe = __webpack_require__(159);

	var _recipe2 = _interopRequireDefault(_recipe);

	var _recipeList = __webpack_require__(163);
	...
	$.ajax({ url: '../processAction.php',
	    ...
	    success: function success(response) {
	        _reactDom2.default.render(_react2.default.createElement(_recipeList2.default, { data: response }), document.querySelector(".container"));
	    }
	});
	/*
	$.ajax({ url: '../processAction.php',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _singleValue = __webpack_require__(160);
	...
	var _ingredients = __webpack_require__(162);
	...
	var Recipe = _react2.default.createClass({
	    ...
	    getData: function getData(label, key) {
	        return {
	            label: label,
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(_singleValue2.default, { data: this.getData("Date modified", "modDate") }),
	                _react2.default.createElement(_steps2.default, { data: {
	                        steps: this.state.recipe.steps,
	                        editable: this.state.editable
	                    } }),
	                _react2.default.createElement(_ingredients2.default, { data: {
	...
	var RecipeList = _react2.default.createClass({
	    ...
	    select: function select(e) {
	        $.ajax({ url: '../processAction.php',
	            ...
	            type: 'POST',
	            success: function success(response) {
	                _reactDom2.default.render(_react2.default.createElement(_recipe2.default, { data: response }), document.querySelector(".container"));
	            }
	        });
	    },
	    render: function render() {
