...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_container2.default, null), document.querySelector(".app-container"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _body = __webpack_require__(160);

	var _body2 = _interopRequireDefault(_body);

	var _utils = __webpack_require__(200);

	var _recipeStore = __webpack_require__(215);
	...
	function getStores() {
	    return [_recipeStore2.default];
	}

	function getState() {
	    return {
	        openRecipe: _recipeStore2.default.getState(),

	        // CALLBACKS
	        saveRecipe: _actions2.default.saveRecipe,
	        getRecipe: _actions2.default.getRecipe,
	        addIngredient: _actions2.default.addIngredient,
	        addStep: _actions2.default.addStep,
	        deleteStep: _actions2.default.deleteStep,
	        deleteIngredient: _actions2.default.deleteIngredient,
	        updateValue: _actions2.default.updateValue
	    };
	}

	exports.default = _utils.Container.createFunctional(_body2.default, getStores, getState);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _recipe = __webpack_require__(163);
	...
	function Body(props) {
	    return _react2.default.createElement(
	        'section',
	        { className: 'app-body' },
	        _react2.default.createElement(_header2.default, { getRecipe: props.getRecipe }),
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(_recipe2.default, {
	...
	var Header = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(_search2.default, { getRecipe: this.props.getRecipe }),
	            _react2.default.createElement(
	                'nav',
	                null,
	                _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Search = _react2.default.createClass({
	    ...
	    getHighlightedTitle: function getHighlightedTitle(title) {
	        var titleHTML = title;
	        var whereToStart = 0;
	    ...
	    getRecipeHTML: function getRecipeHTML(recipe) {
	        return _react2.default.createElement(
	            'div',
	            { className: 'row', key: recipe.id, 'data-id': recipe.id },
	            _react2.default.createElement(
	                'div',
	                { className: 'row-content', onClick: this.select },
	                _react2.default.createElement('img', { className: 'image', src: recipe.picture }),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'details' },
	                    _react2.default.createElement('div', { className: 'title', dangerouslySetInnerHTML: this.getHighlightedTitle(recipe.title) }),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'author' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _singleValue = __webpack_require__(164);

	var _singleValue2 = _interopRequireDefault(_singleValue);

	var _steps = __webpack_require__(169);

	var _steps2 = _interopRequireDefault(_steps);

	var _ingredients = __webpack_require__(172);

	var _ingredients2 = _interopRequireDefault(_ingredients);

	var _recipeHeader = __webpack_require__(177);

	var _recipeHeader2 = _interopRequireDefault(_recipeHeader);

	var _recipeSubHeader = __webpack_require__(180);
	...
	var Recipe = _react2.default.createClass({
	    ...
	    componentDidUpdate: function componentDidUpdate() {
	        ...
	        var croppicContainerModalOptions = {
	            ...
	            onAfterImgCrop: function onAfterImgCrop(o) {
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement('img', { id: 'Cropper', src: this.props.recipe.picture })
	            ),
	            _react2.default.createElement(_recipeSubHeader2.default, { data: this.props.recipe }),
	            _react2.default.createElement(
	                'main',
	...
	var SingleValue = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        if (this.props.data.editable) {
	            value = _react2.default.createElement("input", { onChange: this.update,
	                value: this.props.data.value });
	        }

	        return _react2.default.createElement(
	            "div",
	            { className: "single-value-item" },
	            _react2.default.createElement(
	                "label",
	...
	var Steps = _react2.default.createClass({
	    ...
	    renderDisplay: function renderDisplay(steps) {
	        ...
	        return steps.map(function (step) {
	            return _react2.default.createElement(
	                "li",
	                { className: "individual-step", key: key++ },
	                step
	            );
	        });
	    },
	    renderForm: function renderForm(steps) {
	        ...
	        return steps.map(function (step) {
	            return _react2.default.createElement(
	                "li",
	                { className: "individual-step", key: key++, "data-step-index": key - 1 },
	                _react2.default.createElement(
	                    "div",
	                    { className: "step-content" },
	                    _react2.default.createElement("textarea", { onChange: me.updateStep, value: step }),
	                    _react2.default.createElement("a", { className: "ti-trash", onClick: me.deleteStep })
	                )
	            );
	        });
	    },
	    updateStep: function updateStep(e) {
	        var newSteps = "";
	    ...
	    deleteStep: function deleteStep(e) {
	    ...
	    render: function render() {
	        ...
	        if (this.props.editable) {
	            ...
	            addLink = _react2.default.createElement(
	                "a",
	                { className: "ti-plus", onClick: this.props.add },
	                "Add step"
	            );
	        } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
		// When the styles change, update the <style> tags
		if (!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./steps.scss", function () {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./steps.scss");
				if (typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".recipe-steps .steps-list {\n  padding-left: 0; }\n  .recipe-steps .steps-list .individual-step {\n    padding: 5px; }\n  .recipe-steps .steps-list .step-content {\n    width: 100%;\n    display: inline-flex;\n    flex-direction: row;\n    align-items: center; }\n    .recipe-steps .steps-list .step-content textarea {\n      width: 100%; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ingredients = _react2.default.createClass({
	    ...
	    deleteIngredient: function deleteIngredient(e) {
	    ...
	    renderForm: function renderForm() {
	        ...
	        var list = this.props.ingredients.map(function (ing) {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement('a', { className: 'ti-trash', onClick: me.deleteIngredient })
	            );
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
		// When the styles change, update the <style> tags
		if (!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./ingredients.scss", function () {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./ingredients.scss");
				if (typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".recipe-ingredients ul.editable {\n  padding-left: 0; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Actions = {
	    saveRecipe: function saveRecipe(data) {
	        _dispatcher2.default.dispatch({
	            action: _actionTypes2.default.SAVE_RECIPE,
	            recipe: data
	        });
	    },
	    getRecipe: function getRecipe(data) {
	        _dispatcher2.default.dispatch({
	            action: _actionTypes2.default.GET_RECIPE,
	            id: data
	        });
	    },
	    addIngredient: function addIngredient() {
	        _dispatcher2.default.dispatch({
	            action: _actionTypes2.default.ADD_INGREDIENT
	        });
	    },
	    addStep: function addStep() {
	        _dispatcher2.default.dispatch({
	            action: _actionTypes2.default.ADD_STEP
	        });
	    },
	    deleteStep: function deleteStep(data) {
	        _dispatcher2.default.dispatch({
	            action: _actionTypes2.default.DELETE_STEP,
	            index: data
	        });
	    },
	    deleteIngredient: function deleteIngredient(data) {
	        _dispatcher2.default.dispatch({
	            action: _actionTypes2.default.DELETE_INGREDIENT,
	            index: data
	        });
	    },
	    updateValue: function updateValue(key, value) {
	        _dispatcher2.default.dispatch({
	            action: _actionTypes2.default.UPDATE_VALUE,
	            key: key,
	            value: value
	        });
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".header-content {\n  background-color: #004882;\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center; }\n  .header-content > h1 {\n    color: #f1f1f1;\n    margin: 0;\n    font-size: 50px;\n    font-family: TensoMedium, TensoLight, \"Helvetica Neue\", Helvetica, Arial, sans-serif; }\n  .header-content nav > a {\n    padding-right: 10px;\n    text-decoration: underline; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.Mixin = __webpack_require__(205);
	module.exports.ReduceStore = __webpack_require__(206);
	module.exports.Store = __webpack_require__(207);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FluxStoreGroup = __webpack_require__(203);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FluxStore = __webpack_require__(207);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fbemitter = {
	  EventEmitter: __webpack_require__(209),
	  EmitterSubscription : __webpack_require__(210)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EmitterSubscription = __webpack_require__(210);
	var EventSubscriptionVendor = __webpack_require__(212);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventSubscription = __webpack_require__(211);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RecipeStore = function (_ReduceStore) {
	    _inherits(RecipeStore, _ReduceStore);

	    function RecipeStore() {
	        _classCallCheck(this, RecipeStore);

	        return _possibleConstructorReturn(this, (RecipeStore.__proto__ || Object.getPrototypeOf(RecipeStore)).call(this, _dispatcher2.default));
	    }
	    ...
	    _createClass(RecipeStore, [{
	        ...
	        key: '_processAction',
	        value: function _processAction(action, callback, async) {
	            $.ajax({
	        ...
	        value: function reduce(state, action) {
	            switch (action.action) {
	                case _actionTypes2.default.SAVE_RECIPE:
	                    this._processAction(action, null, false);
	                    return state;
	                case _actionTypes2.default.GET_RECIPE:
	                    var recipe = null;
	                ...
	                case _actionTypes2.default.ADD_INGREDIENT:
	                ...
	                case _actionTypes2.default.ADD_STEP:
	                    var newState = this.getState();
	                    newState.steps += "|";
	                    return Object.assign({}, state, newState);
	                case _actionTypes2.default.DELETE_STEP:
	                    var newState = this.getState();
	                    var steps = newState.steps.split("|");
	                    steps.splice(action.index, 1);
	                    newState.steps = steps.join("|");
	                    return Object.assign({}, state, newState);
	                case _actionTypes2.default.DELETE_INGREDIENT:
	                    var newState = this.getState();
	                    newState.ingredients.splice(action.index, 1);
	                    return Object.assign({}, state, newState);
	                case _actionTypes2.default.UPDATE_VALUE:
	                    var newState = this.getState();
	...
	exports.default = new RecipeStore();
